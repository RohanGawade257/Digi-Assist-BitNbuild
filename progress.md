# VaaniSetu brand and glass refresh — 2026-09-12

Rebranded introduction, navigation, authentication, assistant/PiP titles, metadata, manifest, footer and five spoken introductions. Added an original voice/bridge wordmark, shared glass materials and centralized background configuration. Selected Assests/bg3.png; optimized desktop/mobile copies total under 17KB, with originals preserved. High contrast removes decorative backgrounds and blur; unsupported backdrop filtering gets solid surfaces. The native controller retains shared media/session state and uses honest local tint.

Verification: 16 focused browser checks passed across final and repair runs, covering five-language layouts, capture freshness/consent/recovery, typing/IME/retry, interruption, branding and asset integrity. Final four visual/brand checks passed after repairing production CSS blur overrides. Screenshot inspection covers introduction, workspace, authentication, PiP before/during sharing, chat, mobile and high contrast; automated accessibility scans and keyboard/large-text checks pass. Synthetic browser playback interruption measured 0.7ms from confirmed detection to pause, not physical acoustic latency. Five intro WAVs were generated through real Sarvam; functional browser requests used fixtures. Types, production build and docs checks pass. Physical microphone, other-application focus and whole-display capture inclusion remain unverified; CSS does not provide desktop transparency. See test-results/vaanisetu-gallery.html.

---
# Interface redesign — 2026-09-12

Replaced the stacked presentation with a language-first hero/custom SVG, frosted navigation, conversation + screen workspace, mobile Conversation/Screen tabs, dedicated 390x480 PiP, and native focus-managed dialogs for secondary features. Account deletion, history and feedback are separated. Voice settings are opt-in; expanded PiP chat scrolls independently of its controller. Five-language labels, explicit/revocable capture consent, fresh-frame submission and the existing media controller remain intact. Ending assistance shows Start again and hides the active workspace. Decorative glass fades independently of text; high contrast and reduced motion remain available.

Evidence: rendered screenshots in test-results/redesign-*.png cover introduction, authentication, settings, signed-in workspace, active sharing, PiP before/after sharing, consent, expanded chat, Telugu and mobile. Automated WCAG A/AA scans passed the signed-in workspace and all five localized PiP layouts; keyboard dialog Escape/focus return, large-text scrolling and reduced motion passed. Capture freshness/consent, failed-capture recovery and typed Send/Enter/Shift/IME/retry passed. Five translated conversation/draft checks and voice onboarding/denial passed. Synthetic actual browser playback interruption passed at 0.3ms after confirmed speech detection, with no injected-echo self-interruption and one new utterance. Explicit voice pause/resume, slower silence timing, single submission and End cleanup passed. Fifteen focused browser checks passed across the final runs and targeted repairs; types, production build and docs checks passed. The screenshot gallery is test-results/redesign-gallery.html. No new live-provider or physical microphone/native-desktop validation is claimed.
